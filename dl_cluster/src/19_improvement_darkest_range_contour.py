...
output_root_folder = r'C:\Users\박준형\Desktop\python-workspace\dl_cluster\19_improvement_darkest_range_contour'
...
# [핵심 파라미터]
# 1. 도넛 마스킹 비율 (박스 반지름 기준)
INNER_RATIO = 0.85
OUTER_RATIO = 1.0

# 2. 가장 어두운 영역 추출 허용 오차
# 가장 어두운 값(Min)에서 +40만큼 밝은 영역까지만 톱니로 인정
...
# ==========================================
# 3. 핵심 로직: 도넛 한정 연산 + Darkest Threshold
# ==========================================
def process_gear_improvement(img, filename, save_dirs):
    ...
    # --- 4. [개선] Darkest Region Extraction ---
    # 도넛 마스크 내의 픽셀값만 가져옴
...
if __name__ == '__main__':
    print(f"🚀 [Improved Darkest Range Contour] 시작")
    ...
    print("\n✅ 완료. 19_improvement_darkest_range_contour 폴더를 확인하세요.")